...
** All rights reserved.
**
** DataDistributionManagementEC.h
**
*******************************************************************************/

#ifndef DataDistributionManagementEC_H_
#define DataDistributionManagementEC_H_

#include "EventMarket/DeclarationManagementEC.h"
#include "EventMarket/ObjectManagement.h"

namespace GERTICO
{
  class DataDistributionManagementEC
  {
    ACE_Thread_Mutex &pm;
    GERTICO::DeclarationManagementEC &declarationManagement;
  ...
  public:
    DataDistributionManagementEC(GERTICO::DeclarationManagementEC &theDeclarationManagement, GERTICO::ObjectManagement &theObjectManagement, GERTICO::RunTimeObjectDB &theRunTimeObjectDB, GERTICO::FederatesHolder &theFederatesHolder, GERTICO::ObjectModel &theObjectModel, GERTICO::NextHandle &theIdHandler, GERTICO::JobHolder &theFederationJobs, ACE_Thread_Mutex &thePm);
    virtual ~DataDistributionManagementEC(void);
...
#endif /* DataDistributionManagementEC_H_  */
