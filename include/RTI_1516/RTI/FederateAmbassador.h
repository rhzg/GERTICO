...
namespace RTI
{
  ...
  public:
    ...
    attributesInScope
    (ObjectInstanceHandle const & theObject,
    std::auto_ptr< RTI::AttributeHandleSet > theAttributes)
      throw (ObjectInstanceNotKnown,
             AttributeNotRecognized,
             AttributeNotSubscribed,
             FederateInternalError) = 0;
    ...
    (ObjectInstanceHandle const & theObject,
     std::auto_ptr< RTI::AttributeHandleSet > offeredAttributes,
     UserSuppliedTag const & theUserSuppliedTag)
      throw (ObjectInstanceNotKnown,
             AttributeNotRecognized,
    ...
    (ObjectInstanceHandle const & theObject,
     std::auto_ptr< RTI::AttributeHandleSet > releasedAttributes)
      throw (ObjectInstanceNotKnown,
             AttributeNotRecognized,
             AttributeNotOwned,
    ...
    (ObjectInstanceHandle const & theObject,
     std::auto_ptr< RTI::AttributeHandleSet > securedAttributes,
     UserSuppliedTag const & theUserSuppliedTag)
      throw (ObjectInstanceNotKnown,
             AttributeNotRecognized,
    ...
    (ObjectInstanceHandle const & theObject,
     std::auto_ptr< RTI::AttributeHandleSet > candidateAttributes,
     UserSuppliedTag const & theUserSuppliedTag)
      throw (ObjectInstanceNotKnown,
             AttributeNotRecognized,
             AttributeNotOwned,
