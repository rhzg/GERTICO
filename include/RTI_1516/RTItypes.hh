...
#define MAX_EXTENT                    ((RTI_V1_3::ULong) ~0UL)
#define MIN_EXTENT                    ((RTI_V1_3::ULong) 0UL)
...
#ifdef IEEE_1516
  virtual RTI_V1_3::RegionToken getRegionToken() const
    throw (
      ) = 0;
...
#ifdef IEEE_1516
class RTI_EXPORT RegionSetFactory {
public:
  static Region* create(SpaceHandle theSpace,RegionToken theId,ULong theNumberOfExtents,long id_1,long id_2);
};
#endif
