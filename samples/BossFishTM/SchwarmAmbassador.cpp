...
SchwarmAmbassador::SchwarmAmbassador()
{
	...
	myTime = (*(RTI::FedTimeFactory::makeZero()));
	reqTime = (*(RTI::FedTimeFactory::makeZero()));
	lookahead = (*(RTI::FedTimeFactory::makeZero()));
	timeConstrainedIsEnabled = false;
	timeRegulatedIsEnabled = false;
