...
{
#ifndef GalHLADebug
   cout << "FED_HW: Time granted (timeRegulationEnabled) to: " << theFederateTime << endl;
#endif
...
{
#ifndef GalHLADebug
   cout << "FED_HW: Time granted (timeConstrainedEnabled) to: " << theFederateTime << endl;
#endif
   grantTime = theFederateTime;
   timeAdvGrant = RTI::RTI_TRUE;
...
{
#ifndef GalHLADebug
   cout << "FED_HW: Time granted (timeAdvanceGrant) to: " << theTime << endl;
#endif
   grantTime = theTime;
   timeAdvGrant = RTI::RTI_TRUE;
}
