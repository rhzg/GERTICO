...
$Log: SchwarmAmbassador.h,v $
Revision 1.1  2003/05/16 09:44:53  hzg
Basis functionality
...
#ifndef SchwarmAmbassador_h
#define SchwarmAmbassador_h
...
//
//-----------------------------------------------------------------
class SchwarmAmbassador : public RTI::FederateAmbassador
{
public:
	std::map<RTI::ObjectHandle,Fish*> swarm;
	UpdateListener *observer;

public:
	RTI::ObjectClassHandle fishClass;
    RTI::AttributeHandle attributePosX;
    RTI::AttributeHandle attributePosY;

	long updates;

  bool waiting;
  bool synchronizationPointRegistrationSucceededFlag;
  bool announceSynchronizationPointFlag;
  bool federationSynchronizedFlag;
  bool timeRegulationEnabledFlag;
  bool enableTimeConstrainedFlag;
  bool startRegistrationFlag;
  bool discoverObjectInstanceFlag;
  bool requestAttributeOwnershipAssumptionFlag;
  bool attributeOwnershipAcquisitionNotificationFlag;
  bool timeAdvGrant;
  bool initiateSaveFlag;
  char* saveLabel;

  RTIfedTime grantTime;

  RTI::ObjectClassHandle objectHandle;
  RTI::ObjectClassHandle objectClassHandle;
  char* tag;
  RTI::ObjectHandle expectedObject;


SchwarmAmbassador();
virtual ~SchwarmAmbassador() throw(RTI::FederateInternalError);
