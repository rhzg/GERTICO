...
Revision 1.2  2003/11/27 12:22:02  hzg
...
throw (
  ...
  RTI::FederateInternalError)
{
	cout << " SchwarmAmbassador::discoverObjectInstance (obj = " 
		<< theObject << ", class = " << theObjectClass << ")" << endl;

	swarm[theObject] = new Fish();
}
  ...
  RTI::FederateInternalError)
{
	...
	if (updates % 100 == 0) observer->updated();
}
